...
route.post("/loginUser", async (req, res) => {
    ...
    if (data == null) {
        ...
        console.log('login user name : ' + req.session.loginUser.name + req.session.loginUser.type);
...
route.post('/saveDish', async (req, res) => {
    ...
    photo.mv("C:/Users/The Amehs/Desktop/Online-food-ordering-system-main/public/dishImage/" + imageName);
    if (data) {
